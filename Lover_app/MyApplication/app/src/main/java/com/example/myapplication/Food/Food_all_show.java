 ...
 */
public class Food_all_show extends Activity implements SwipeRefreshLayout.OnRefreshListener, AMapLocationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_all_show);
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case REFRESH_COMPLETE:
                        ...
                        service.get(getApplication(), "show_Food_city.php", params, new Listener() {
                            public void Success(String str) {
                                Log.i("8855555", str);
                                //获取电影的爬虫数据
                                List<food_item> list = new ArrayList<food_item>();
                                Gson gson = new Gson();
                                list = gson.fromJson(str, new TypeToken<List<food_item>>() {
                                }.getType());
                                Log.i("8855555", list.get(0).getName());
                                //电影适配器
                                view_list.setAdapter(new Food_Adapter(getApplication(), list));
                            }
