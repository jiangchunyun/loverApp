...
import com.example.myapplication.Food.Food_Adapter;
import com.example.myapplication.Food.food_item;
import com.example.myapplication.Listener;
import com.example.myapplication.R;
import com.example.myapplication.Service;
import com.example.myapplication.View.View_Adapter;
...
public class Hotel_all_show extends Activity implements SwipeRefreshLayout.OnRefreshListener, AMapLocationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hotel_all_show);
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case REFRESH_COMPLETE:
                        ...
                        service.get(getApplication(), "showallHotel.php", params, new Listener() {
                            public void Success(String str) {
                                Log.i("8855555", str);
                                //获取电影的爬虫数据
                                List<hotel_item> list = new ArrayList<hotel_item>();
                                Gson gson = new Gson();
                                list = gson.fromJson(str, new TypeToken<List<hotel_item>>() {
                                }.getType());
                                Log.i("8855555", list.get(0).getName());
                                //电影适配器
                                view_list.setAdapter(new Hotel_Adapter(getApplication(), list));
                            }
