...
public class views extends AppCompatActivity implements AMapLocationListener,PoiSearch.OnPoiSearchListener {
    ...
    public  void search(int i)
    {
        ...
        PoiSearch.Query query=new PoiSearch.Query("游乐园","");
